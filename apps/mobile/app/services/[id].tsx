...
import { SERVICE_CATEGORY_LABELS, ServiceCategory, formatCurrency } from '@fitora/shared';
      ...
      >
        {listing ? (
          ...
          >
            ...
            {(['pickupAddress', 'pickupPhone', 'pickupCity', 'equipmentDetails', 'customerNotes'] as const).map(
              (field) => (
                <View key={field}>
