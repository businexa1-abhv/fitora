        ...
        {mobileOpen && (
          ...
          >
            <nav className="flex flex-col p-4 gap-1">
              ...
              <Link href="/login" onClick={() => setMobileOpen(false)} className="px-4 py-3 text-sm font-medium">
                Sign in
              </Link>
              <Link href="/register" onClick={() => setMobileOpen(false)} className="btn-primary mt-2">
                Get started
              </Link>
            </nav>
          </motion.div>
