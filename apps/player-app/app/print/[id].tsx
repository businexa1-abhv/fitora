      ...
      >
        {listing ? (
          ...
          >
              ...
              {TSHIRT_SIZE_OPTIONS.map((size) => (
                ...
                >
                  <Text
                    style={{
                      color:
                        form.tshirtSize === size ? colors.primaryForeground : colors.foreground,
                    }}
                  >
                    {size}
                  </Text>
              ...
              {TSHIRT_COLOR_OPTIONS.slice(0, 6).map((color) => (
                <Pressable
                  ...
                  style={[
                    ...
                    {
                      backgroundColor:
                        form.tshirtColor === color.name ? colors.primary : colors.card,
                      borderColor: colors.border,
                    },
                  ]}
                >
            ...
            {(
              ['quantity', 'pickupAddress', 'pickupPhone', 'pickupCity', 'customerNotes'] as const
            ).map((field) => (
              <View key={field}>
